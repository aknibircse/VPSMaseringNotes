...
```
- Install MongoDB https://github.com/geekyshow1/VPSMaseringNotes/blob/main/InstallConfigMongoDB.md
- Install PM2 
```sh
...
npm install
```
- Connect to MongoDB shell with Super User, To Create Super User Follow https://github.com/geekyshow1/VPSMaseringNotes/blob/main/CreateMongoDBUser.md
```sh
