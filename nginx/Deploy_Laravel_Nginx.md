...
git --version
```
- Install Nginx, PHP and MySQL https://github.com/geekyshow1/VPSMaseringNotes/blob/main/nginx/LEMP_Stack_Installation.md
- Install Composer https://github.com/geekyshow1/VPSMaseringNotes/blob/main/Install_Composer.md
- Install Node and NPM https://github.com/geekyshow1/VPSMaseringNotes/blob/main/Install_Node_NPM.md
- Install Git
 ```sh
...
```
- Open Mysql
- Create Database User https://github.com/geekyshow1/VPSMaseringNotes/blob/main/AssignMySQL_DB_To_User.md
- Create Database
- Open .env File
```sh
